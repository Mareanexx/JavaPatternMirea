...
import edu.mareanexx.services.EmailService;
...
public class PostOfficeController {
    ...
    public ResponseEntity<List<PostOfficeDTO>> getPostOfficeList() {
        emailService.sendEmail("marianna310104@mail.ru", "Добавлено новое почтовое отделение!",
                "Произошло добавление данного почтового отделения: ");
